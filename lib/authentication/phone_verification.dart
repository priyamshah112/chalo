...
class PhoneVerification extends StatefulWidget {
  ...
  static const route = '/Phone-Verification';
...
class _PhoneVerificationState extends State<PhoneVerification> {
                                                  ...
                                                  if (result) {
                                                    _codeSent
                                                        ? await signInwithOTP(
                                                            ...
                                                            photoUrl)
                                                        : await sendOTP(
                                                            email, _phone, password, photoUrl);
                                                  } else {
                                                    setState(
                                                        () => _sendingOTP = false);
                                                    showDialog(
  ...
  Future<void> sendOTP(String email, String phone, String password,String photoUrl, [int resendToken]) async {
    ...
    await auth.verifyPhoneNumber(
        ...
        verificationCompleted: (AuthCredential creds) async {
          ...
          showSuccess(context,email,password,photoUrl,creds);
        },
  ...
  Future<void> signInwithOTP(verID, smsCode, phone, email, password, photoUrl) async {
    showDialog(
        context: context,
  ...
  void showSuccess(BuildContext ctx, String email, String password, String photoUrl, AuthCredential creds) async {
    isLoading = false;
    showDialog(
      context: ctx,
      builder: (ctx) => DialogBox(
